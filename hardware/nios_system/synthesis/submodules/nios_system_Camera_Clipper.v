...
module nios_system_Camera_Clipper (
	// Inputs
	clk,
	reset,
...
parameter WIDTH_IN					= 480; // Incoming frame's width in pixels
parameter HEIGHT_IN					= 270; // Incoming frame's height in lines
...
parameter DROP_LINES_AT_START		= 15;
parameter DROP_LINES_AT_END		= 15;
